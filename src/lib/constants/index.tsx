...
export const dashboardLinks = [
  ...
  },
  {
    ...
    icon: (
      ...
      >
        <path
          d="M2.64172 6.19971L10 10.458L17.3084 6.22468"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        ...
        />
        <path
          d="M8.27501 2.0665L3.82502 4.54153C2.81668 5.09986 1.9917 6.49985 1.9917 7.64985V12.3582C1.9917 13.5082 2.81668 14.9082 3.82502 15.4665L8.27501 17.9415C9.22501 18.4665 10.7833 18.4665 11.7333 17.9415L16.1834 15.4665C17.1917 14.9082 18.0167 13.5082 18.0167 12.3582V7.64985C18.0167 6.49985 17.1917 5.09986 16.1834 4.54153L11.7333 2.0665C10.775 1.53317 9.22501 1.53317 8.27501 2.0665Z"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M14.1666 11.0332V7.98321L6.2583 3.4165"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
  ...
  //     >
  //       <path
  //         d="M8.9597 14.0503V15.742C8.9597 17.1753 7.62636 18.3336 5.98469 18.3336C4.34302 18.3336 3.00134 17.1753 3.00134 15.742V14.0503C3.00134 15.4836 4.33469 16.5003 5.98469 16.5003C7.62636 16.5003 8.9597 15.4753 8.9597 14.0503Z"
  //         stroke="currentColor"
  //         strokeWidth="1.5"
  //         strokeLinecap="round"
  //         strokeLinejoin="round"
  ...
  //       />
  //       <path
  //         d="M8.9597 11.7582V14.0498C8.9597 15.4832 7.62636 16.4998 5.98469 16.4998C4.34302 16.4998 3.00134 15.4748 3.00134 14.0498V11.7582C3.00134 10.3248 4.33469 9.1665 5.98469 9.1665C6.80969 9.1665 7.55138 9.45815 8.09305 9.92481C8.62638 10.3915 8.9597 11.0415 8.9597 11.7582Z"
  //         stroke="currentColor"
  //         strokeWidth="1.5"
  //         strokeLinecap="round"
  //         strokeLinejoin="round"
  //       />
  //       <path
  //         d="M18.3333 9.14147V10.8582C18.3333 11.3165 17.9667 11.6915 17.5 11.7082H15.8667C14.9667 11.7082 14.1417 11.0498 14.0667 10.1498C14.0167 9.62482 14.2167 9.13315 14.5667 8.79148C14.875 8.47482 15.3 8.2915 15.7667 8.2915H17.5C17.9667 8.30817 18.3333 8.68314 18.3333 9.14147Z"
  //         stroke="currentColor"
  //         strokeWidth="1.5"
  //         strokeLinecap="round"
  //         strokeLinejoin="round"
...
export const companyLocations = [
  {
    ...
    address: "1234 Broadway Ave, Suite 500",
    city: "New York",
    country: "USA",
  ...
  {
    id: "dubai",
    name: "Middle East Office - Dubai",
    address: "Dubai Marina, Sheikh Zayed Road",
    city: "Dubai",
    country: "UAE",
