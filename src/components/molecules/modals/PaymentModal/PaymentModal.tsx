...
const PaymentModal = ({
  ...
  const {
    ...
    isSubmitting,
    selectedImageFile,
  } = usePaymentOptions(orderId, quoteId, onClose);
    ...
    <>
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="max-w-3xl w-full  ">
          ...
          <div className="space-y-3 max-h-[30vh] overflow-y-auto overflow-x-hidden">
      ...
      <UploadPaymentProofModal
        ...
        uploadBankTransferProof={uploadBankTransferProof}
        orderId={orderId}
      />
    </>
  );
